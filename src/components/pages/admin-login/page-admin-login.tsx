...
export const PageAdminLogin = () => {
  ...
  const handlerSetLoginData = () => {
    ...
    dispatch(
      setLoginData({
        openModalType: null,
        loginFrom: login?.loginFrom || 'admin-login',
  ...
  return (
    <ContainerPageAdminLogin>
      <div className="PageAdminLogin_inner">
        <div className="PageAdminLogin_r1">
          <p>{t('modals-and-forms:::FormLogin::text8')}</p>
        </div>

        <div className="PageAdminLogin_r2">
          <FormLogin />
        </div>
      </div>
    </ContainerPageAdminLogin>
...
const ContainerPageAdminLogin = styled(StylePageDivCenter)`
  display: flex;
  justify-content: center;
  margin: 0 auto;

  .PageAdminLogin_inner {
    padding-top: 128px;
  }
