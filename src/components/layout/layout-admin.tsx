...
export const LayoutAdmin = (props: NLayoutAdmin.IProps) => {
  const {
    showNavbar = true,
    showWebNavbar = true,
  ...
  return (
    <ContainerLayoutAdmin
      id="__LayoutAdmin"
      className={joinClasses('__LayoutAdmin__', ...classNames)}
      classNames={classNames}
    >
      {NavbarComponent}
...
const ContainerLayoutAdmin = styled.div<NLayoutAdmin.IStyle>`
  --screenWidth: 0px;
  --screenHeight: 0px;
