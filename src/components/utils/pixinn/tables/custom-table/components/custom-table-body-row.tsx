...
import { CustomTableBodyCell } from './custom-table-body-cell';

export const CustomTableBodyRow = <T extends {}>(
  props: NCustomTableBodyRow.IProps<T>
): JSX.Element => {
  const {
    isLoadingNewData,
    loadMore,
...
export namespace NCustomTableBodyRow {
  export interface IProps<T> {
    ...
    bodyRow: NCustomTable.TTableBodyRowDataProps<T>;
    bodyRowIndex: number;
