...
export const PixinnInputSelect = (props: NPixinnInputSelect.IProps) => {
  const classNames = [props?.select?.isDisabled ? 'isDisabled' : '']?.filter?.(
    (v) => v
  );

  return (
    <ContainerPixinnInputSelect className={joinClasses(``, ...classNames)}>
      <ReactSelect
        {...omit(
          props?.select,
          'className',
        ...
        classNamePrefix={joinClasses(`PixinnInputSelectPrefix`)}
    ...
    </ContainerPixinnInputSelect>
  );
};

export namespace NPixinnInputSelect {
...
const ContainerPixinnInputSelect = styled.div`
  --height: 56px;
  --paddingTop: 25px;
  --paddingRight: 18px;
  --paddingBottom: 7px;
  ...
  .PixinnInputSelectPrefix__control {
    cursor: pointer;
  ...
  .PixinnInputSelectPrefix__control--is-focused {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  }

  .PixinnInputSelectPrefix__value-container {
    margin: 0;
    padding: 0 var(--paddingRight) 0 var(--paddingLeft);
    min-height: var(--height);
  }

  .PixinnInputSelectPrefix__single-value {
  ...
  .PixinnInputSelectPrefix__placeholder {
    display: none;
  }
  ...
  .PixinnInputSelectPrefix__input-container {
    margin: 0;
    padding: var(--paddingTop) 0 var(--paddingBottom) 0;
  ...
  .PixinnInputSelectPrefix__menu-list {
    padding: 10px;
  }

  .PixinnInputSelectPrefix__option {
    cursor: pointer;
    padding: 9.5px 16px;
    border-radius: 8px;
  ...
  .PixinnInputSelectPrefix__option--is-focused {
    background-color: #fafafa;
  }

  .PixinnInputSelectPrefix__option--is-selected {
  ...
  // hover
  .PixinnInputSelectPrefix__control:hover {
  ...
  .PixinnInputSelectPrefix__control--is-focused,
  .PixinnInputSelectPrefix__control--is-focused:hover {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  ...
  // has value
  .PixinnInputSelectPrefix__value-container--has-value
    ~ .__Custom_Placeholder__ {
    top: 6px;
