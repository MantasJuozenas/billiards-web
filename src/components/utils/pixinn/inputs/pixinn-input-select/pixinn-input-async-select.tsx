...
export const PixinnInputAsyncSelect = (
  props: NPixinnInputAsyncSelect.IProps
) => {
  ...
  return (
    <ContainerPixinnInputAsyncSelect className={joinClasses(``, ...classNames)}>
      <ReactAsyncSelect
        {...omit(
          props?.select,
          'className',
        ...
        classNamePrefix={joinClasses(`PixinnInputAsyncSelectPrefix`)}
    ...
    </ContainerPixinnInputAsyncSelect>
  );
};

export namespace NPixinnInputAsyncSelect {
...
const ContainerPixinnInputAsyncSelect = styled.div`
  --height: 56px;
  --paddingTop: 25px;
  --paddingRight: 18px;
  --paddingBottom: 7px;
  ...
  .PixinnInputAsyncSelectPrefix__control {
    cursor: pointer;
  ...
  .PixinnInputAsyncSelectPrefix__control--is-focused {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  }

  .PixinnInputAsyncSelectPrefix__value-container {
    margin: 0;
    padding: 0 var(--paddingRight) 0 var(--paddingLeft);
    min-height: var(--height);
  }

  .PixinnInputAsyncSelectPrefix__single-value {
  ...
  .PixinnInputAsyncSelectPrefix__placeholder {
    display: none;
  }
  ...
  .PixinnInputAsyncSelectPrefix__input-container {
    margin: 0;
    padding: var(--paddingTop) 0 var(--paddingBottom) 0;
  ...
  .PixinnInputAsyncSelectPrefix__menu {
    margin: 9px 0;
    border-radius: 8px;
  ...
  .PixinnInputAsyncSelectPrefix__menu-list {
    padding: 10px;
  }

  .PixinnInputAsyncSelectPrefix__option {
    cursor: pointer;
    padding: 9.5px 16px;
    border-radius: 8px;
  ...
  .PixinnInputAsyncSelectPrefix__option--is-focused {
    background-color: #fafafa;
  }

  .PixinnInputAsyncSelectPrefix__option--is-selected {
  ...
  // hover
  .PixinnInputAsyncSelectPrefix__control:hover {
  ...
  .PixinnInputAsyncSelectPrefix__control--is-focused,
  .PixinnInputAsyncSelectPrefix__control--is-focused:hover {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  ...
  // has value
  .PixinnInputAsyncSelectPrefix__value-container--has-value
    ~ .__Custom_Placeholder__ {
    top: 6px;
