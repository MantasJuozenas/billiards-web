...
export const PixinnInputCreatableSelect = (
  props: NPixinnInputCreatableSelect.IProps
) => {
  ...
  return (
    <ContainerPixinnInputCreatableSelect
    ...
    >
      <ReactCreatableSelect
        ...
        classNamePrefix={joinClasses(`PixinnInputCreatableSelectPrefix`)}
...
export namespace NPixinnInputCreatableSelect {
...
const ContainerPixinnInputCreatableSelect = styled.div`
  --height: 56px;
  --paddingTop: 25px;
  --paddingRight: 18px;
  --paddingBottom: 7px;
  ...
  .PixinnInputCreatableSelectPrefix__control {
    cursor: pointer;
  ...
  .PixinnInputCreatableSelectPrefix__control--is-focused {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  }

  .PixinnInputCreatableSelectPrefix__value-container {
    margin: 0;
    padding: 0 var(--paddingRight) 0 var(--paddingLeft);
    min-height: var(--height);
  }

  .PixinnInputCreatableSelectPrefix__single-value {
  ...
  .PixinnInputCreatableSelectPrefix__placeholder {
    display: none;
  }
  ...
  .PixinnInputCreatableSelectPrefix__input-container {
    margin: 0;
    padding: var(--paddingTop) 0 var(--paddingBottom) 0;
  ...
  .PixinnInputCreatableSelectPrefix__menu {
    margin: 9px 0;
    border-radius: 8px;
  ...
  .PixinnInputCreatableSelectPrefix__menu-list {
    padding: 10px;
  }

  .PixinnInputCreatableSelectPrefix__option {
    cursor: pointer;
    padding: 9.5px 16px;
    border-radius: 8px;
  ...
  .PixinnInputCreatableSelectPrefix__option--is-focused {
    background-color: #fafafa;
  }

  .PixinnInputCreatableSelectPrefix__option--is-selected {
  ...
  // hover
  .PixinnInputCreatableSelectPrefix__control:hover {
  ...
  .PixinnInputCreatableSelectPrefix__control--is-focused,
  .PixinnInputCreatableSelectPrefix__control--is-focused:hover {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  ...
  // has value
  .PixinnInputCreatableSelectPrefix__value-container--has-value
    ~ .__Custom_Placeholder__ {
    top: 6px;
