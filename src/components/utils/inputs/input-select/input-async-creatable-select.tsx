...
export const InputAsyncCreatableSelect = (
  props: NInputAsyncCreatableSelect.IProps
) => {
  ...
  return (
    <ContainerInputAsyncCreatableSelect
    ...
    >
      <ReactAsyncCreatableSelect
        ...
        classNamePrefix={joinClasses(`InputAsyncCreatableSelectPrefix`)}
...
export namespace NInputAsyncCreatableSelect {
...
const ContainerInputAsyncCreatableSelect = styled.div`
  --height: 56px;
  --paddingTop: 25px;
  --paddingRight: 18px;
  --paddingBottom: 7px;
  ...
  .InputAsyncCreatableSelectPrefix__control {
    cursor: pointer;
  ...
  .InputAsyncCreatableSelectPrefix__control--is-focused {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  }

  .InputAsyncCreatableSelectPrefix__value-container {
    margin: 0;
    padding: 0 var(--paddingRight) 0 var(--paddingLeft);
    min-height: var(--height);
  }

  .InputAsyncCreatableSelectPrefix__single-value {
  ...
  .InputAsyncCreatableSelectPrefix__placeholder {
    display: none;
  }
  ...
  .InputAsyncCreatableSelectPrefix__input-container {
    margin: 0;
    padding: var(--paddingTop) 0 var(--paddingBottom) 0;
  ...
  .InputAsyncCreatableSelectPrefix__menu {
    margin: 9px 0;
    border-radius: 8px;
  ...
  .InputAsyncCreatableSelectPrefix__menu-list {
    padding: 10px;
  }

  .InputAsyncCreatableSelectPrefix__option {
    cursor: pointer;
    padding: 9.5px 16px;
    border-radius: 8px;
  ...
  .InputAsyncCreatableSelectPrefix__option--is-focused {
    background-color: #fafafa;
  }

  .InputAsyncCreatableSelectPrefix__option--is-selected {
  ...
  // hover
  .InputAsyncCreatableSelectPrefix__control:hover {
  ...
  .InputAsyncCreatableSelectPrefix__control--is-focused,
  .InputAsyncCreatableSelectPrefix__control--is-focused:hover {
    box-shadow: var(--borderFocus);
    background-color: #ffffff;
  ...
  // has value
  .InputAsyncCreatableSelectPrefix__value-container--has-value
    ~ .__Custom_Placeholder__ {
    top: 6px;
